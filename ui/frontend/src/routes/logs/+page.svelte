...
<div class="space-y-6">
	<div class="flex items-center justify-between">
		...
		<div class="flex items-center gap-4">
			...
			<button onclick={clearLogs} class="px-3 py-1.5 bg-gray-800 text-gray-400 rounded text-sm hover:bg-gray-700">
				Clear
			</button>
			<button onclick={downloadLogs} class="px-3 py-1.5 bg-[#00d4ff]/20 text-[#00d4ff] rounded text-sm hover:bg-[#00d4ff]/30">
				Download
			</button>
		</div>
	</div>
	...
	<div class="flex gap-2">
		<button
			...
			class="px-3 py-1.5 rounded text-sm {filterLevel === 'all' ? 'bg-[#00d4ff]/20 text-[#00d4ff]' : 'bg-gray-800 text-gray-400 hover:bg-gray-700'}"
		>
			All
		</button>
		<button
			onclick={() => filterLevel = 'info'}
			class="px-3 py-1.5 rounded text-sm {filterLevel === 'info' ? 'bg-[#00ff88]/20 text-[#00ff88]' : 'bg-gray-800 text-gray-400 hover:bg-gray-700'}"
		>
			Info
		</button>
		<button
			onclick={() => filterLevel = 'warning'}
			class="px-3 py-1.5 rounded text-sm {filterLevel === 'warning' ? 'bg-[#ffaa00]/20 text-[#ffaa00]' : 'bg-gray-800 text-gray-400 hover:bg-gray-700'}"
		>
			Warning
		</button>
		<button
			onclick={() => filterLevel = 'error'}
			class="px-3 py-1.5 rounded text-sm {filterLevel === 'error' ? 'bg-[#ff0040]/20 text-[#ff0040]' : 'bg-gray-800 text-gray-400 hover:bg-gray-700'}"
		>
			Error
		</button>
	</div>
	...
	<!-- Log output -->
	<div class="bg-[#0a0a0f] rounded-lg border border-gray-800 p-4 font-mono text-sm h-[600px] overflow-y-auto">
